...
pushd "$BASE_DIR" > /dev/null
    ...
    mv ../telemetry ./
    sed 's/path = "..\/telemetry"/path = ".\/repo\/src\/software\/telemetry"/' Cargo.toml > Cargo.toml
    ...
    mv ./telemetry ../
    sed 's/path = ".\/repo\/src\/software\/telemetry"/path = "..\/telemetry"/' Cargo.toml > Cargo.toml
