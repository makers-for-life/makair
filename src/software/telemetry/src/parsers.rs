...
mod tests {
    ...
    prop_compose! {
        fn data_snapshot_message_strategy()(
            version in ".*",
            device_id in device_id_ints_strategy(),
            systick in (0u64..),
            centile in (0u16..),
    ...
    prop_compose! {
        fn machine_state_message_strategy()(
            version in ".*",
            device_id in device_id_ints_strategy(),
            systick in (0u64..),
            cycle in (0u32..),
    ...
    prop_compose! {
        fn alarm_trap_message_strategy()(
            version in ".*",
            device_id in device_id_ints_strategy(),
            systick in (0u64..),
            centile in (0u16..),
    ...
    proptest! {
        #[test]
        fn test_boot_message_parser(msg_and_extra_datas in boot_message_strategy()) {
            let (msg, device_id) = msg_and_extra_datas;
    ...
    proptest! {
        #[test]
        fn test_stopped_message_parser(msg_and_extra_datas in stopped_message_strategy()) {
            let (msg, device_id) = msg_and_extra_datas;
    ...
    proptest! {
        #[test]
        fn test_data_snapshot_message_parser(msg_and_extra_datas in data_snapshot_message_strategy()) {
             let (msg, device_id, (phase, subphase)) = msg_and_extra_datas;
    ...
    proptest! {
        #[test]
        fn test_machine_state_snapshot_message_parser(msg_and_extra_datas in machine_state_message_strategy()) {
             let (msg, device_id) = msg_and_extra_datas;
    ...
    proptest! {
        #[test]
        fn test_alarm_trap_message_parser(msg_and_extra_datas in alarm_trap_message_strategy()) {
             let (msg, device_id, (phase, subphase)) = msg_and_extra_datas;
