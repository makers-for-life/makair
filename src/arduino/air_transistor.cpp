...
AirTransistor::AirTransistor()
    : minApertureAngle(ANGLE_OUVERTURE_MINI),
      maxApertureAngle(ANGLE_OUVERTURE_MAXI), defaultCommand(ANGLE_FERMETURE),
      failsafeCommand(ANGLE_FERMETURE - ANGLE_OUVERTURE_MAXI),
      command(ANGLE_FERMETURE), position(ANGLE_FERMETURE) {}
...
AirTransistor::AirTransistor(uint16_t p_minApertureAngle,
    ...
    : minApertureAngle(p_minApertureAngle),
      maxApertureAngle(p_maxApertureAngle), defaultCommand(p_defaultCommand),
      failsafeCommand(p_failsafeCommand), command(ANGLE_FERMETURE),
